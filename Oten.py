...
def file_subb(uid,pwx):
    ...
    try:
        for ps in pwx:
            user_agent="Dalvik/2.1.0 (Linux; U; Android 9; moto e6 Build/PCB29.73-65-3) [FBAN/Orca-Android;FBAV/196.0.0.29;FBPN/com.facebook.orca;FBLC/zh_CN;FBBV/474580609;FBCR/3SE;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1809;FBSV/4.5.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=720,height=1080};FB_FW/1;FBRV/792224820"
            data = {
            "adid": str(uuid.uuid4()),
            "format": "json",
